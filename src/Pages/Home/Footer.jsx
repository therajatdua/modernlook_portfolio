  ...
  return (
    <footer className="footer--container">
          ...
          <ul>
            <li>
              ...
              >
                ...
                >
                  <path
                    d="M28.25,9.5225a4.125,4.125,0,0,0-2.9175-2.9175C23.33,6,16.5,6,16.5,6s-6.83,0-8.8325.605A4.125,4.125,0,0,0,4.75,9.5225,43.125,43.125,0,0,0,4.125,16.5,43.125,43.125,0,0,0,4.75,23.4775a4.125,4.125,0,0,0,2.9175,2.9175C9.67,27,16.5,27,16.5,27s6.83,0,8.8325-.605a4.125,4.125,0,0,0,2.9175-2.9175A43.125,43.125,0,0,0,28.875,16.5,43.125,43.125,0,0,0,28.25,9.5225ZM13.875,20.625v-8.25l7.2175,4.125Z"
                    fill="black"
                  />
                </svg>
              </a>
            ...
            <li>
              <a
                href="https://www.x.com/rajatxdua"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/rajat-dua-554889223/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made with 💖 by Rajat Dua</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <button
                onClick={() => openModal('privacy')}
                className="text-sm footer-link-btn"
              >
                Privacy Policy
              </button>
            </li>
