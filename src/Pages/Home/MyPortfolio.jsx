    ...
    <section className="portfolio--section" id="MyPortfolio">
      <div className="portfolio--container-box">
        ...
        <div>
          <button 
            ...
            onClick={() => window.open('https://github.com/rajatxdua', '_blank')}
          >
            <svg
      ...
      <div className="portfolio--section--container">
        {data?.portfolio?.map((item, index) => (
          <div key={index} className="portfolio--card-hover">
            <div className="portfolio--image-container">
              ...
              <div className="portfolio--overlay">
                <div className="portfolio--overlay-content">
                  ...
                  {item.description && (
                    <p className="portfolio--overlay-description">{item.description}</p>
                  )}
                  <div className="portfolio--overlay-links">
                    {item.url && (
                      <button 
                        className="portfolio--overlay-btn primary"
                    ...
                    {item.github && (
                      <button 
                        className="portfolio--overlay-btn secondary"
